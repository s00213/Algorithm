...
namespace _00._Algorithm
{
    internal class Program
    {
        ...
        /******************************************************
		 * 자료구조 (DataStructure) -> 데이터와 처리를 빠르게 접근하는 방법 찾기
		 * 
        ...
        // 일반적으로 시간을 위해 공간이 희생되는 경우가 많음 : 무어의 법칙
        // 시간복잡도 : 알고리즘의 시간적 자원 소모량
        // 공간복잡도 : 알고리즘의 공간적 자원 소모량

        // <Big-O 표기법>
        // 알고리즘의 복잡도를 나타내는 점근표기법(어떤 함수의 증가 양상을 다른 함수와의 비교로 표현하는 수론과 해석학의 방법)
        // 가장 높은 차수의 계수와 나머지 모든 항을 제거하고 표기
        // 알고리즘의 대략적인 효율을 파악할 수 있는 수단 (정확한 효율이 아님)
